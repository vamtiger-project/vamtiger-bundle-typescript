...
var createBundlePath = path_1.resolve(__dirname, '../../bin/index.js');
...
describe('vamtiger-bundle-typescript: commandline should', function () {
    it('bundle typescript into a single file', function () {
        return __awaiter(this, void 0, void 0, function () {
            var cleared, makeEntryfileModulePathFolder, createEntryFile, createEntryFileModule, createBundle, bundleFileText;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, vamtiger_bash_1.default(createTypescriptBundle)];
                    case 5:
